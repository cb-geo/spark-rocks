...
class InputProcessingSpec extends FunSuite {
  ...
  test("Properly formatted input file should lead to expected rock volume and joints") {
    ...
    val expectedFaces = Vector[Array[Double]](
    ...
    val expectedJoints = Vector[Array[Double]](
      Array(60.0, 25.0, 0.5, 100.0, 30.0, 0.0),
      Array(132.0, 30.0, 0.5, 100.0, 27.0, 0.0, 2.6, 3.7, 0.05),
      Array(315.0, 67.0, 1.0, 70.0, 14.0, 12.0, 1.3, 7.2, 0.07, 10.0)
    )
